    ...
    return (
        <div className="flex min-h-screen flex-col bg-white text-[#111121]">
            <div className="w-full border-b border-[rgba(0,0,0,0.05)]">
                <div className="mx-auto w-full max-w-[375px] md:max-w-none md:px-10">
                    <div className="h-[44px] bg-white md:hidden" aria-hidden/>
                    <div className="flex h-[52px] items-center px-3 md:h-[64px] md:px-0">
                        <button
                            type="button"
            ...
            <div className="flex flex-1 justify-center px-4 py-6 md:px-10 md:py-10 lg:px-16">
                <div className="relative flex w-full max-w-[375px] flex-col rounded-[24px] bg-white pb-12 md:max-w-[720px] md:rounded-[32px] md:pb-16">
                    <h1 className="sr-only">검색</h1>

                    <form onSubmit={handleSubmit} className="relative mt-6 flex justify-center px-3 md:mt-8 md:px-6">
                        <div
                            className={cn(
                    ...
                    >
                        <div className="relative flex h-12 items-center rounded-[10px] bg-white px-[14px] md:h-14 md:px-5">
                            ...
                            />
                            {isSubmitting ? (
                                <Loader2 className="absolute right-[14px] top-1/2 size-4 -translate-y-1/2 animate-spin text-[#445bff] md:right-[20px] md:size-5"/>
                            ) : searchTerm ? (
                                <button
                                    type="button"
                                    onClick={clearSearch}
                    ...
                    <main className="mt-5 px-3 md:mt-8 md:px-6">
                        {activeQuery ? (
                            <div className="mx-auto flex w-full max-w-[351px] flex-col space-y-8 md:max-w-none md:flex-row md:gap-8 md:space-y-0">
                                <div className="space-y-8 md:w-[340px] md:flex-none lg:w-[360px]">
                                <section className="space-y-3">
                                    <h2 className="text-[16px] font-semibold tracking-[-0.4px] md:text-[18px]">검색된 토픽</h2>
                                    <div className="flex flex-wrap gap-2">
                                        {isRelatedTopicsLoading ? (
                                            ...
                                            relatedTopics.map((topic) => (
                                                ...
                                                >
                                                    <span className="inline-flex h-full w-full items-center gap-1 rounded-full bg-white px-6 text-[14px] font-semibold tracking-[-0.35px] text-[#111121]">
                                                        <span
                                                            className={cn(
                                ...
                                <div className="h-2 w-full rounded-full bg-[#eef0f3] md:hidden"/>
                            </div>

                            <section className="flex-1 space-y-4 md:space-y-6">
                                <div className="flex items-center justify-between gap-3 text-[12px] tracking-[-0.3px] text-[#999999] md:text-[13px]">
                                    <span>검색된 토픽</span>
                                ...
                                <div className="space-y-4 md:space-y-5">
                                    {isRelatedTopicsLoading ? (
                                        ...
                                        relatedTopics.map((topic) => (
                                            <article
                                                key={topic.id}
                                                className="rounded-[16px] bg-white p-4 shadow-[0px_12px_30px_-22px_rgba(62,83,255,0.4)] md:p-5"
                                            >
                                                <Link
                                                    to="/topics/$topicId"
                                                    params={{topicId: topic.id.toString()}}
                                                ...
                                                >
                                                    ...
                                                    <p className="text-[14px] leading-[1.6] tracking-[-0.35px] text-[#555970] md:text-[15px]">
                        ...
                        <div className="mx-auto flex w-full max-w-[351px] flex-col space-y-8 md:max-w-none md:flex-row md:gap-8 md:space-y-0">
                                    ...
                                    <div className="flex gap-2 overflow-x-auto pb-1 md:flex-wrap md:overflow-visible">
                                        {recommendedLoading ? (
                                            ...
                                            recommendedTopics.map((topic) => (
                                                ...
                                                >
                                                    <span className="inline-flex h-full w-full items-center gap-1 rounded-full bg-white px-6 text-[14px] font-semibold tracking-[-0.35px] text-[#111121] md:text-[15px]">
                                                        <span
                                                            className={cn(
                                                                "bg-gradient-to-r bg-clip-text font-semibold text-transparent",
                                                                HASH_GRADIENT_CLASSES,
                                            ...
                                            <p className="text-sm text-[#999999] md:text-[15px]">추천 토픽을 불러오지 못했어요.</p>
                                        )}
                                    </div>
                                </section>
                            ...
                            <section className="flex-1 space-y-3">
                                <div className="flex items-center justify-between">
                                    <h2 className="text-[16px] font-semibold tracking-[-0.4px] md:text-[18px]">인기 토픽</h2>
                                    <div className="flex items-center gap-1 text-[12px] font-normal tracking-[-0.3px] text-[#999999] md:text-[13px]">
                                        ...
                                        topKTopics.map((topic, index) => {
                                            ...
                                            return (
                                                <Link
                                                    ...
                                                    to="/topics/$topicId"
                                                    params={{topicId: topic.id.toString()}}
                                                    className="flex items-center gap-3 rounded-[8px] px-2 py-2 transition hover:bg-[rgba(87,125,255,0.08)]"
                                                >
                                                    <span
                                                        className={cn(
                                                    ...
                                                    <span className="text-[14px] font-semibold tracking-[-0.35px] text-[#111121] md:text-[15px]">
                                                        {topic.title}
                                                    </span>
                                                </Link>
                                            );
