                ...
                {overlay !== 'none' ? (
                    ...
                    <div className="text-right mt-2 mr-1 pl-4">
                        {!imageLoaded ? (
                            ...
                            <>
                                <p className="text-xl md:text-2xl font-bold text-opacity-80 truncate">{title}</p>
                                <p className="text-sm md:text-base text-gray-500/80  line-clamp-2">{description}</p>
                            </>
                        )}
                    </div>
                )}
