...
export function TopicTags({ topics = defaultTopics }: TopicTagsProps) {
  return (
    <div className="box-border content-stretch flex flex-col gap-[12px] items-start px-[12px] py-0 relative shrink-0 w-full">
      <div className="content-stretch flex gap-[8px] items-center relative rounded-[2px] shrink-0 sm:justify-center md:justify-start lg:justify-center">
      ...
      <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full overflow-x-auto sm:justify-center md:flex-wrap md:overflow-x-visible md:justify-start lg:justify-center xl:gap-[12px]">
        {topics.map((topic, index) => (
          <div 
            key={index}
            className="bg-[rgba(255,255,255,0.3)] box-border content-stretch flex gap-[6px] h-[36px] items-center px-[12px] py-[6px] relative rounded-[20px] shrink-0 transition-all duration-200 hover:bg-[rgba(255,255,255,0.4)] cursor-pointer"
          >
