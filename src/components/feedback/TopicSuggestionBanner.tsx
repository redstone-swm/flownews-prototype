                ...
                <CardContent className="py-4 px-4">
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <div className="text-center">
                            <h2 className="text-2xl md:text-3xl font-bold text-black dark:text-white leading-none tracking-tight mb-1">
                                시점이 요약해줬으면 하는 주제를 제안해주세요!
                            </h2>
                        </div>

                        <p className="text-stone-500 dark:text-stone-300 text-sm md:text-base text-center max-w-xl leading-none tracking-tight ">
